            ...
            <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                    <div className={cn("lg:col-span-7", {
                        "rounded-lg border-2 border-dashed border-zinc-200 p-12": isMouted && items.length === 0,
                    })}>
                        ...
                        {isMouted && items.length == 0 ? (
                            <div className="flex h-full flex-col items-center justify-center space-y-1">
                                <div aria-hidden='true' className="relative mt-4 h-40 w-40 text-muted-foreground">
                                    <Image src="/hippo-empty-cart.png" fill loading="eager" alt="empty shoppung cart hippo"/>
                                </div>
                        ...
                        <ul className={cn({
                            "divide-y divide-gray-200 border-b boder-t border-gray-200": isMouted && items.length >0
                        })}>
                            {isMouted && items.map(({product})=>{
